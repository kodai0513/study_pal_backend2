...
class CreateWorkbookReq(StudyPalPydanticBaseModel):
    title: str = Field(max_length=50)
    description: str = Field(max_length=400)


class UpdateWorkbookReq(StudyPalPydanticBaseModel):
    title: str = Field(max_length=50)
    description: str = Field(max_length=400)


class WorkbookResp(IdResponseSchema, TimeResponseSchema):
    description: str
    is_public: bool
    title: str
    user_id: str
